...
import { View, Text, Pressable, SafeAreaView, TextInput, Alert, Platform, ActivityIndicator } from "react-native";
        ...
        <SafeAreaView style={rateStyles.safe}>
            <View style={rateStyles.fullScreenWhite}>
                ...
                <Pressable onPress={handleUpdate} disabled={saving} style={[rateStyles.formSaveButton, saving && { opacity: 0.6 }]}>
                    {saving ? <ActivityIndicator color="#fff" /> : <Text style={rateStyles.formSaveText}>Save Changes</Text>}\
                </Pressable>
            </View>
        </SafeAreaView>
    );
