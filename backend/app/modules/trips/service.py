...
class TripsService:
    def __init__(self, repo: TripRepo, category_repo: RateCategoryRepo, customization_repo: RateCustomizationRepo, expense_service=None, audit_service: AuditTrailService = None):
        self.repo = repo
