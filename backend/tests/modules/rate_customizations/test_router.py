...
class TestCreateRateCustomizationEndpoint:
    ...
    @pytest.mark.asyncio
    async def test_create_customization_success(self, mock_service, mock_customization):
        ...
        result = await create_rate_customization(body, mock_service)

        assert result == mock_customization
        mock_service.create_rate_customization.assert_called_once_with(body)

    @pytest.mark.asyncio
    async def test_create_customization_invalid_data(self, mock_service):
        from app.modules.rate_customizations.router import create_rate_customization
        ...
        with pytest.raises(HTTPException) as exc_info:
            await create_rate_customization(body, mock_service)
        
        assert exc_info.value.status_code == 400

    @pytest.mark.asyncio
    async def test_create_customization_persistence_error(self, mock_service):
        from app.modules.rate_customizations.router import create_rate_customization
...
class TestGetCustomizationEndpoint:
    ...
    @pytest.mark.asyncio
    async def test_get_customization_success(self, mock_service, mock_customization):
        ...
        result = await get_customization(customization_id, mock_service)

        assert result == mock_customization
        mock_service.get_customization.assert_called_once_with(customization_id)

    @pytest.mark.asyncio
    async def test_get_customization_not_found(self, mock_service):
        from app.modules.rate_customizations.router import get_customization
        ...
        with pytest.raises(HTTPException) as exc_info:
            await get_customization(customization_id, mock_service)
...
class TestEditCustomizationEndpoint:
    ...
    @pytest.mark.asyncio
    async def test_edit_customization_success(self, mock_service, mock_customization):
        ...
        result = await edit_customization(body, customization_id, mock_service)

        assert result == mock_customization
        mock_service.edit_customization.assert_called_once_with(customization_id, body)

    @pytest.mark.asyncio
    async def test_edit_customization_partial_update(self, mock_service, mock_customization):
        from app.modules.rate_customizations.router import edit_customization
    ...
    @pytest.mark.asyncio
    async def test_edit_customization_not_found(self, mock_service):
        from app.modules.rate_customizations.router import edit_customization
        ...
        with pytest.raises(HTTPException) as exc_info:
            await edit_customization(body, customization_id, mock_service)
        
        assert exc_info.value.status_code == 404

    @pytest.mark.asyncio
    async def test_edit_customization_invalid_data(self, mock_service):
        from app.modules.rate_customizations.router import edit_customization
...
class TestDeleteCustomizationEndpoint:
    ...
    @pytest.mark.asyncio
    async def test_delete_customization_success(self, mock_service):
        ...
        result = await delete_customization(customization_id, mock_service)

        mock_service.delete_customization.assert_called_once_with(customization_id)
        assert result.status_code == 204

    @pytest.mark.asyncio
    async def test_delete_customization_not_found(self, mock_service):
        from app.modules.rate_customizations.router import delete_customization
        ...
        with pytest.raises(HTTPException) as exc_info:
            await delete_customization(customization_id, mock_service)
